// WhatsApp's mark, drawn in the colour of the text around it. Shared by the
// footer, the contact page and the order form's phone label — the size is the
// caller's, since the label needs it at text height and the others at 20px.
export default function IconWhatsApp({ className = 'h-5 w-5' }) {
  return (
